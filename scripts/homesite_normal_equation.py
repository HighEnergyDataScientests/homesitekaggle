...
print("Step 1")
X_train_transpose = X_train.values.T
print("Step 2")
mult_x = np.dot(X_train_transpose,X_train.values)
print("Step 2")
invVal = np.linalg.pinv(mult_x)
print("Step 3")
xAllVal = np.dot(invVal, X_train_transpose)
print("Step 4")
theta = np.dot(xAllVal, y_train.values)
print("Step 5")
print(theta)
